...
save(MainArray, file="../RNNArrays/MainArray.rda")
save(IDVect, file="../RNNArrays/IDVect.rda")
save(Val.Array, file="../RNNArrays/Val.Array.rda")
save(Val.IDVect, file="../RNNArrays/Val.IDVect.rda")

#Loading all of it
load(file="../RNNArrays/MainArray.rda")
load(file="../RNNArrays/IDVect.rda")
load(file="../RNNArrays/Val.Array.rda")
load(file="../RNNArrays/Val.IDVect.rda")
...
# RNN %>% fit(MainArray, IDVect, epochs=100)

RNN %>% save_model_hdf5("../Models/TrainedSexRNN")
